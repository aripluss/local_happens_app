...
class _EventsPageState extends State<EventsPage> {
  ...
  final List<Map<String, dynamic>> _categories = [
    ...
    {'name': 'Розваги', 'icon': Icons.festival_rounded, 'color': Colors.grey},
    {'name': 'Бізнес', 'icon': Icons.business_center, 'color': Colors.grey},
    {'name': 'Інше', 'icon': Icons.spa, 'color': Colors.grey},
  ];
